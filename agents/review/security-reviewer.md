...
model: opus
description: Review code changes for OWASP Top 10 vulnerabilities, injection flaws, auth bypass, secrets exposure, input validation gaps, config file safety, and credential management.
---
