...
description: Web search for current best practices related to the target technology or pattern. Conditionally triggered for unfamiliar tech, external integrations, or high-risk topics.
alwaysApply: false
---
...
- No strong local context (sparse project docs, few existing patterns)

**Skip conditions:**
- Strong local context exists (good patterns in codebase, project docs have guidance)
...
Reason: Codebase has 15+ examples of this pattern,
        project docs document the convention,
