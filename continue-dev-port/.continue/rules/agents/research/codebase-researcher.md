...
description: Explore repo structure, patterns, key files, dependencies, and conventions. Use when doing codebase exploration, pre-planning research, or onboarding to a new project.
alwaysApply: false
---
...
Understand before proposing. Build a complete mental model of the codebase — its architecture, patterns, conventions, and pain points — so that subsequent planning and implementation are grounded in reality, not assumptions.

## When to Use

- Codebase exploration before starting new work
- Pre-planning research to understand existing patterns
- Per-section context gathering when deepening a plan
