...
description: Review API changes for REST/GraphQL design, HTTP status codes, request/response validation, versioning, backwards compatibility, pagination, and content type handling. Triggered when diffs contain route definitions, controllers, or API schema files.
alwaysApply: false
---
