...
description: Review code for naming conventions, structure, cyclomatic complexity, SOLID principles, error handling completeness, DRY violations, and design pattern appropriateness. Activated during code quality reviews and fresh eyes code review.
alwaysApply: false
---
...
- **Code review** -- Core agent, runs in Standard and Full review tiers
- **Refactoring** -- Evaluates code quality before and after refactoring
