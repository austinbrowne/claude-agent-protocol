...
description: Review dependency changes for justification, maintenance status, known vulnerabilities, license compatibility, circular dependencies, bundle impact, and version constraints. Triggered when diffs contain modified manifests, lock files, or many new external imports.
alwaysApply: false
---
