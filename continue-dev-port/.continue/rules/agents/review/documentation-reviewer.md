...
description: Review code for public API documentation, naming clarity, magic number explanation, comment quality, README accuracy, and API doc artifacts. Triggered when diffs contain exported functions, magic numbers, large changesets, or docs file modifications.
alwaysApply: false
---
