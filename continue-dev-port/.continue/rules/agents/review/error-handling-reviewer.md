...
description: Review code for try/catch completeness, error propagation, retry logic, circuit breakers, timeout handling, error message safety, and graceful degradation. Triggered when diffs contain HTTP calls, file I/O, try/catch patterns, or external service integrations.
alwaysApply: false
---
