...
description: Review code for N+1 queries, algorithmic complexity issues, memory leaks, missing pagination, caching gaps, database index usage, bundle size impact, and concurrency throughput. Triggered when diffs contain database/ORM patterns, nested loops, or large changesets.
alwaysApply: false
---
...
- **Plan deepening** -- Reviews performance implications of proposed architecture
