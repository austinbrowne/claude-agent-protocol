...
description: Review plans and code for YAGNI compliance, over-engineering detection, unnecessary abstractions, premature optimization, feature creep, and dependency minimalism. Activated during plan reviews and refactoring evaluations.
alwaysApply: false
---
...
- **Plan deepening** -- Identifies unnecessary complexity in detailed sections
- **Refactoring** -- Evaluates whether refactoring adds justified simplification
