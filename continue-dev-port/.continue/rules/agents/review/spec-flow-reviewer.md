---
name: Spec and Flow Reviewer
description: Review plans for user flow completeness, error states, empty states, loading states, edge cases in flows, permission states, accessibility, and onboarding/first-use states. Activated during plan reviews and spec validation.
alwaysApply: false
---
...
- **Plan deepening** -- Identifies missing states in detailed plan sections
- **Plan generation** -- Reviews plan for flow completeness before issue creation
