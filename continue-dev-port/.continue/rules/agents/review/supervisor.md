...
description: Consolidate specialist review findings, deduplicate overlapping issues, remove false positives, prioritize by severity and real-world impact, and produce actionable todo specifications. Runs after all specialist review agents complete.
alwaysApply: false
---
...
- **Code review** -- Runs AFTER all specialist agents complete (Standard and Full tiers)
