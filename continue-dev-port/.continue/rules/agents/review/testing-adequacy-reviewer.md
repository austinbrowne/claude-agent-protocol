...
description: Review test coverage for new code, test quality, mock appropriateness, assertion specificity, edge case test coverage, test isolation, integration tests, and test naming clarity. Triggered when diffs contain test files or implementation without corresponding tests.
alwaysApply: false
---
...
- **Test generation** -- Evaluates quality after generation
