...
description: OWASP Top 10 security review checklist for AI-generated code. Automatically triggered for files touching auth, login, sessions, tokens, passwords, crypto, secrets, keys, credentials, JWT, or OAuth.
alwaysApply: false
globs: "**/*{auth,login,session,token,password,crypto,secret,key,credential,jwt,oauth}*"
---
