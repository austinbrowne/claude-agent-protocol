---
alwaysApply: false
description: "Recovery report template — referenced by /recovery for documenting implementation failures"
globs:
---
...
```bash
# Cross-platform note: adjust commands for your OS shell (bash, zsh, PowerShell, etc.)
