---
alwaysApply: false
description: "Test strategy matrix template — referenced by /generate-tests for test planning guidance"
globs:
---
...
```bash
#!/bin/bash
# Cross-platform note: adapt for your shell (bash/zsh on macOS/Linux, PowerShell on Windows)
set -e
